...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/bg11.jpg);" data-stellar-background-ratio="0.5">
		  <div class="home-slider owl-carousel">
	      <div class="slider-item js-fullheight">
	      	<div class="overlay"></div>
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/bp112.jpg" alt="">
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/bg+1.png" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
    				...
    				<div class="text">
    					...
    					<div class="appointment-wrap">
    						<span class="subheading">Reservation</span>
								...
								<span class="subheading">| We Will Confirm Your Appointment Through Your EMAIL or PHONE CALL |</span>
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/bg-01.jpg);">
						</div>
					</div>
    		</div>
    	</div>
